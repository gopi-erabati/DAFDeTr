...
def main():
    ...
    if 'freeze_lidar_components' in cfg and cfg[
        ...
        for name, param in model.named_parameters():
            ...
            if 'bbox_head.bev_level_embeds' in name:  # for encoder lidar
                param.requires_grad = False
            if 'bbox_head.encoder_lidar' in name:  # for encoder lidar
                param.requires_grad = False
